...
<div id="main">
    ...
    <div id="header">
        ...
        <div id="sorting-buttons">
            <label>
            <input type="radio" name="sorting" value="popularity" id="popularitySorting" checked> 
            <span data-translate="popularityLabel">Popularity</span>
            </label>
            <label>
            <input type="radio" name="sorting" value="release" id="releaseSorting">
            <span data-translate="releaseLabel">Release</span>
            </label>
        </div>
