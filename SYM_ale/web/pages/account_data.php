...
<div style="z-index:1; width:100%">
 <div class="w3-bar w3-grey w3-left-align w3-large">
  ...
  if (isset($_SESSION['id'])&& $_SESSION['is_admin']==0)?><a href="/profiloutente.php" class="w3-bar-item w3-button w3-hide-small palette-netflix-bright-red w3-padding-large w3-hover-white" title="Account"> Torna indietro </i></a>
  <?php if(isset($_SESSION['id'])&& $_SESSION['is_admin']==1)?><a href="/admin.php" class="w3-bar-item w3-button w3-hide-small palette-netflix-bright-red w3-padding-large w3-hover-white" title="Account"> Torna indietro </i></a> 
  <?php 
  if(!isset($_SESSION))session_start(); 
    ...
    <div class="row">
        ...
        <div class="col">
            <div class="w3-container w3-card w3-white w3-round w3-margin">
                <br>
                <h4>Email</h4><br>
                <button type="button" class="w3-button palette-netflix-bright-red" style="margin-bottom: 16px;"> Cambia Email </button>
            </div>
            <div class="w3-container w3-card w3-white w3-round w3-margin">
                <br>
                <h4>Password</h4><br>
                <button type="button" class="w3-button palette-netflix-bright-red" style="margin-bottom: 16px;"> Cambia Password </button>
            </div>
        </div>
        -->
    </div>
