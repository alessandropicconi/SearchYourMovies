...
function getMovies(myJson){
    ...
    sendReview = ` 
                ...
                <button class="bottone palette-netflix-bright-red w3-padding-16" type="submit" name="movieId" value="${id_film}" id="review-send"> Invia
                </button>
    ...
    commentButtons = `
                <button type="submit" name="movieId" value="${id_film}" id="comment-send" style="background:none;border:none;display:block">Invia</button>
                <input type="hidden" name="movieTitle" value="${myJson.title}" />
    `;
